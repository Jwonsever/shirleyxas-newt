...
#define VERSION 0.99
#define YEAR 2009
#define BUILDSTAMP "Tue Aug 31 10:00:15 WST 2010"
...
#define INIT_FILE "gdis.settings"
...
CORE_GROWTH_SLICE, CORE_REGION, CORE_TRANSLATE, CORE_FF, CORE_SOF,
...
enum {CARTESIAN, OTHER, ANGSTROM, BOHR, DEGREES, RADIANS, NANOMETERS};
...
/* rendering primitive subsets */
enum {RENDER_SOLID, RENDER_GHOST, RENDER_WIRE, RENDER_LINE, RENDER_LAST};
...
/* FIXME -remove when siesta_pak is properly separated */
#include "siesta_pak.h"
#include "pak.h"
