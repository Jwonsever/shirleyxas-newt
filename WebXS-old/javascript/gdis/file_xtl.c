...
/* retrieve */
    ...
    fprintf(fp,"%4s %10.5f %10.5f %10.5f %7.4f  0.0000 %7.4f   %-2s%d%c\n",
      core->atom_label, vec[0], vec[1], vec[2], atom_charge(core),
      core->sof, symbol, charge, (elem_data.charge>=0?'+':'-'));
    }
  }
fprintf(fp,"EOF\n");
