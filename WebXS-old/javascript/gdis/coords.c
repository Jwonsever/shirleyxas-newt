...
/**************************************/
gdouble coords_scale_get(struct model_pak *model)
{
gdouble scale=1.0;
...
/* TODO - scale the latmat/pbc too? */
/* CURRENT - case by case basis - use coords_scale_get() */
