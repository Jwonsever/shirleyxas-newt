...
enum 
{
MS_ACCESSIBLE, MS_MOLECULAR, MS_DENSITY_VALUE,
...
MS_GAUSS_CUBE,
MS_SIESTA_RHO, MS_SIESTA_DRHO, MS_SIESTA_LDOS, MS_SIESTA_VH, MS_SIESTA_VT,
MS_LAST
};
...
void surface_print_planes(GSList *);
...
gpointer surface_hkl_find(gdouble *, GSList *, struct model_pak *);

void sculpt_model_create(gdouble, struct surface_pak *, struct model_pak *);

void update_plane_energy(struct plane_pak *, struct surface_pak *);
...
void surface_symmetry_generate(struct surface_pak *, struct model_pak *);
