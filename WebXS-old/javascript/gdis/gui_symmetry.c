...
{
struct model_pak *data = tree_model_get();
...
if (BadOptimization)
  gui_text_show(WARNING, "Symmetry element refinement did not converge.\n");
...
/* actions */
  gui_button_x("Find Symmetry", gui_symmetry_analyse, NULL, box);
  gui_button_x("Convert to P1", edit_make_p1, NULL, box);
//  gui_button_x("Asymmetric unit ", gui_symmetry_toggle, NULL, box);
  }
else
  {
  struct model_pak *model = tree_model_get();
