...
gdouble coords_scale_get(struct model_pak *);
...
void core_init(const gchar *, struct core_pak *, struct model_pak *);
gpointer core_new(const gchar *, const gchar *, struct model_pak *);
gpointer shell_new(const gchar *, const gchar *, struct model_pak *);
...
void atom_colour_refresh(struct core_pak *, struct model_pak *);
...
void connect_midpoints(struct model_pak *);
