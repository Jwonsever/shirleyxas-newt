...
void quat_mult(gdouble *, gdouble *);
void quat_concat(gdouble *, gdouble *, gdouble);
void quat_concat_euler(gdouble *, gint, gdouble);
void quat_rotate(gdouble *, gdouble *);
void quat_matrix(gdouble *, gdouble *);
void quat_convert_matrix(gdouble *, gdouble *);
void quat_nlerp(gdouble *, gdouble *, gdouble *, gdouble);
