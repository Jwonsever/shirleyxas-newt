...
from arcs.shibboleth.client import Shibboleth, CredentialManager, Idp, SimpleCredentialManager
...
def slcs_idp_list(url):

  print "slcs_idp_list()"

  return

# SDF - changed signature to permit C to pass arguments
...
#        settings.myproxy_user = "dearjohn"
