...
void property_add_with_units(gint,
                             gchar *, gchar *, gchar *,
                             struct model_pak *);

void property_replace(const gchar *, const gchar *, struct model_pak *);
guint property_rank(gpointer);
gchar *property_label(gpointer);
gchar *property_value(gpointer);
const gchar *property_lookup(const gchar *, struct model_pak *);
gint property_remove(const gchar *, struct model_pak *);
gint property_ranking(gpointer, gpointer);

void gulp_init(gpointer);
void gamess_init(gpointer);
void siesta_init(gpointer);
