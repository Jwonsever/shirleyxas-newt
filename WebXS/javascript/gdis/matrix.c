...
/* dot produce for 3 */
/*********************/
gdouble dotprod(gdouble *v1, gdouble *v2)
{
gdouble v[3];
...
if (matrix_invert(mat2))
  {
  gui_text_show(ERROR, "Two or more lattice vectors are not independent.");
  return;
  }
...
{
#define I_TOLERANCE 1.0E-07

if (fabs(*(mat+0)-1.0) < I_TOLERANCE)
  return(FALSE);
if (fabs(*(mat+4)-1.0) < I_TOLERANCE)
  return(FALSE);
if (fabs(*(mat+8)-1.0) < I_TOLERANCE)
  return(FALSE);

if (fabs(*(mat+1)) < I_TOLERANCE)
  return(FALSE);
if (fabs(*(mat+2)) < I_TOLERANCE)
  return(FALSE);
if (fabs(*(mat+3)) < I_TOLERANCE)
  return(FALSE);

if (fabs(*(mat+5)) < I_TOLERANCE)
  return(FALSE);
if (fabs(*(mat+6)) < I_TOLERANCE)
  return(FALSE);
if (fabs(*(mat+7)) < I_TOLERANCE)
  return(FALSE);
