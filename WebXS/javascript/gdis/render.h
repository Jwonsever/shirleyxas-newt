...
enum 
{
STICK, BALL_STICK, CPK, CPK_STICK, LIQUORICE, POLYHEDRAL, ZONE,
...
/* prototypes */
void render_pipes_setup(struct model_pak *);
void render_atoms_setup(struct model_pak *);

void render_pipe_colour_refresh(gpointer, struct model_pak *);
...
void povray_exec(const gchar *, const gchar *);
gint povray_exec_async(const gchar *, const gchar *);

void render_refresh(struct model_pak *);
