...
GSList *list=NULL, *model_list=NULL;
struct core_pak *core;
FILE *fp;
...
/* parsing for column info ie x,y,z positions frac/cart etc. */
      case CIF_ATOM_SITE:
        ...
        while (g_strrstr(line, "atom_site") != NULL)
          ...
          if (g_strrstr(line, "cart"))
            data->fractional = FALSE;
          if (g_strrstr(line, "frac"))
            data->fractional = TRUE;

          if (g_strrstr(line, "_x"))
            x_pos = loop_count;
          if (g_strrstr(line, "_y"))
            y_pos = loop_count;
          if (g_strrstr(line, "_z"))
            z_pos = loop_count;
