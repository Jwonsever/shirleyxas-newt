...
function previousJobs() {
    ...
    $('#previousjobslist').html("<div id='previousUnfinishedJobs'>"
				+ "<h3>Unfinished Calculations Available for Resubmission</h3><center>"
...
function loadJobOutputs(myHtml, directory, jobName, webdata)
{
    ...
    jmolOptsHtml += "<br>View Model <select id = 'currModel' onmouseup='redrawModel(\""+directory + "\",\""+jobName + "\")'>";
    ...
    stHtml += "Atm#<input id='cuAt' type='text' size='4' value='"+XAS[0]+"'/><br>";
    stHtml += "M#<input id='cuMo' type='text' size='4' value='1'/><br>";
...
function drawState(atomNo, activeMo, state) {
    ...
    $.newt_ajax({type: "POST",
		    ...
		    success: function(res) {
			 ...
			 scr = "set echo top left;font echo 16;echo \"Load Failed!  State file does not exist yet.\";refresh;";
			 Jmol.script(resultsApplet, scr);
			 return;
		     }
